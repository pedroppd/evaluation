...
public class EvaluationService {
    private final TravelPackageUserRepositoryImpl travelPackageUserRepositoryImpl;
    ...
    public List<TravelPackageDTO> getEvaluationByTravelPackageUuid(String travelPackageUuid, String keyword) throws InternalServerError {
        ...
        try {
            List<Object[]> resultList = travelPackageUserRepositoryImpl.getEvaluationByKeyWord(travelPackageUuid, keyword);
